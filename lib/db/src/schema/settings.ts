...
export const settingsTable = pgTable("settings", {
  ...
  preferredContractTypes: text("preferred_contract_types").notNull().default("CALL,PUT,DIGITOVER,DIGITUNDER,DIGITEVEN,DIGITODD"),
  ...
  recoveryMultiplier: numeric("recovery_multiplier", { precision: 4, scale: 2 }).notNull().default("1.5"),
  ...
  normalOverDigit: integer("normal_over_digit").notNull().default(2),
  normalUnderDigit: integer("normal_under_digit").notNull().default(7),
  recoveryOverDigit: integer("recovery_over_digit").notNull().default(4),
  recoveryUnderDigit: integer("recovery_under_digit").notNull().default(5),
